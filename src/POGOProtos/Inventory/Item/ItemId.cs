...
namespace POGOProtos.Inventory.Item {
  ...
  public enum ItemId {
    ...
    [pbr::OriginalName("ITEM_POKE_BALL")] Item寶貝球 = 1,
    [pbr::OriginalName("ITEM_GREAT_BALL")] Item高級球 = 2,
    [pbr::OriginalName("ITEM_ULTRA_BALL")] Item超級球 = 3,
    [pbr::OriginalName("ITEM_MASTER_BALL")] Item頂級球 = 4,
    [pbr::OriginalName("ITEM_POTION")] Item藥水 = 101,
    [pbr::OriginalName("ITEM_SUPER_POTION")] Item強效藥水 = 102,
    [pbr::OriginalName("ITEM_HYPER_POTION")] Item超級藥水 = 103,
    [pbr::OriginalName("ITEM_MAX_POTION")] Item頂級藥水 = 104,
    [pbr::OriginalName("ITEM_REVIVE")] Item復活石 = 201,
    [pbr::OriginalName("ITEM_MAX_REVIVE")] Item頂級復活石 = 202,
    ...
    [pbr::OriginalName("ITEM_RAZZ_BERRY")] Item莓果 = 701,
